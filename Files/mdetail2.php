...
// LINK EXAMPLE: https://kahnawakenews.com/lib/mdetail.php?app=Y&pop=Y&dm=Yes&l=vaccinations-of-yearolds-to-begin-second-doses-coming-soon-p3490-1.htm
// LINK EXAMPLE: https://bulletlink.com/lib/mdetail.php?app=Y&pop=Y&dm=Yes&l=https://bulletlink.com/template-100/cameron-diaz-offers-her-truth-%27everyone-will-be-cheated-on%27-p179-100.htm
...
if (strlen($FileContentMain) > 0) {
    ...
    echo "<script>if (window.location.href.indexOf('mdetail2.php') != -1 && $(window).width() > 1024 && window == window.parent) {mburl = location.href;var mbar= new URL(mburl );var murl= mbar.searchParams.get('l');window.location.replace(murl);}</script>" . chr(13) . chr(10);
    ...
    echo "</head><body class='mobilebody' onload='OpenLoginPopupM(window.location.href);'>" . chr(13) . chr(10);
